 ...
 */
        ...
        parameters.add("approval_url", "54.180.182.1:8080/payment/success"); // 성공 시 redirect url
        parameters.add("cancel_url", "54.180.182.1:8080/payment/cancel"); // 취소 시 redirect url
        parameters.add("fail_url", "54.180.182.1:8080/payment/fail"); // 실패 시 redirect url
